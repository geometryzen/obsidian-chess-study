...
describe('get_variation_depth', () => {
	test('variations', () => {
		...
		expect(get_variation_depth(null, e5_node)).toBe(-1);
		expect(get_variation_depth(root, root)).toBe(0);
		expect(get_variation_depth(root, e5_node)).toBe(0);
		expect(get_variation_depth(root, d5_node)).toBe(1);
		expect(get_variation_depth(root, d4_node)).toBe(1);
		expect(get_variation_depth(root, Nf6_node)).toBe(1);
		expect(get_variation_depth(root, Nf3_node)).toBe(2);
		expect(get_variation_depth(root, b6_node)).toBe(2);
	});
});
